...
$instanceType = (Get-EC2InstanceAttribute -InstanceId $instanceId -Attribute instanceType -Region us-east-1).InstanceType
...
$Info = Get-ComputerInfo -Property "CsName","TimeZone","WindowsProductName","OsType","OsVersion","WindowsEditionId","OsTotalVisibleMemorySize","OsFreePhysicalMemory","CsNumberOfLogicalProcessors","CsNumberOfProcessors","CsProcessors"
...
Start-Process NotePad -ArgumentList $OutputFile