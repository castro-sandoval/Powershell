...
if (Test-Path -Path $TSQL_restoreFile) {
    ...
    foreach($line in $file) {
        if ($line.Contains("RESTORE DATABASE")) {
            ...
            #   EC2AMAZ-RO6HDEV/Backups/Week_20180723/
            ...
            if (Test-Path -Path $filePath) {
                ...
                $sqlFiles = (Invoke-Sqlcmd -Query $sqlcmd -ServerInstance $ServerInstance  -Database "master")
                ...
                Invoke-Sqlcmd -Query $sqlRestorecmd -ServerInstance $ServerInstance  -Database "master" -QueryTimeout 2400
                ...
                if ($sqlRestorecmd.Contains(" RECOVERY")) {
                    ...
                    Invoke-Sqlcmd -Query $checkdbCmd -ServerInstance $ServerInstance  -Database "master" -Verbose 4> $VerboseOutput
                    ...
                    Invoke-Sqlcmd -Query ("DROP DATABASE ["+$dbname+"]") -ServerInstance $ServerInstance  -Database "master"
    ...
    if ($ErrorsFound -eq $TRUE) {
        ...
        Invoke-Sqlcmd -Query $cmd -ServerInstance $ServerInstance  -Database "master"
    }
